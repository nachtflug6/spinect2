...
//public class HitPointOriginal : MonoBehaviour
//{
...
//            //GameObject fbxAssetPrefab;

//            model3d = ObjFromUrl.ObjFromStream.LoadObjectFromStream(urlPath);
//            model3d.transform.localScale = new Vector3(0.01f, 0.01f, 0.01f);
...
//    {
//        ExecuteServer();
//        urlPath = Server.Program.url_path;
//    }
//}
