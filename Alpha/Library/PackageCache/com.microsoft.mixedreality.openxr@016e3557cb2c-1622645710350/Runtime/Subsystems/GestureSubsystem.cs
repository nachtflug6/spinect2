...
namespace Microsoft.MixedReality.OpenXR
{
    ...
    internal struct NativeGesturePoseData
    {
        ...
        public NativePoseFlags headPoseFlags;
        public Pose eyeGazePose;
        public NativePoseFlags eyeGazePoseFlags;
        public Pose handAimPose;
        public NativePoseFlags handAimPoseFlags;
        public Pose handGripPose;
        public NativePoseFlags handGripPoseFlags;
    }
    ...
    internal static class GestureSubsystemExtensions
    {
        ...
        public static bool IsValid(this NativePoseFlags flags)
        {
            return flags.HasFlag(NativePoseFlags.OrientationValid) &&
            flags.HasFlag(NativePoseFlags.PositionValid);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsTracked(this NativePoseFlags flags)
        {
            return flags.HasFlag(NativePoseFlags.OrientationTracked) &&
            flags.HasFlag(NativePoseFlags.PositionTracked);
        }
    ...
    {
        private readonly static NativeLibToken nativeLibToken = HoloLensFeaturePlugin.nativeLibToken;
        ...
        internal static GestureSubsystem TryCreateGestureSubsystem(GestureSettings settings)
        {
            ...
            {
                Debug.LogError($"HoloLensFeaturePlugin is not enabled.");
                return null;
            }
