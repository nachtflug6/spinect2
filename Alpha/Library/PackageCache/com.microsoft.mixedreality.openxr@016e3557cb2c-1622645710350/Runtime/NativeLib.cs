...
namespace Microsoft.MixedReality.OpenXR
{
    ...
    internal class NativeLib
    {
        ...
        [DllImport(DllName, EntryPoint = "openxr_plugin_GetViewConfigurationTypesCount")]
        internal static extern uint GetViewConfigurationTypesCount(NativeLibToken token);

        [DllImport(DllName, EntryPoint = "openxr_plugin_GetViewConfigurationTypes")]
        internal static extern void GetViewConfigurationTypes(NativeLibToken token, ViewConfigurationType[] viewConfigurationTypes, uint viewConfigurationTypesCapacity);
        ...
        internal static extern void SetMeshComputeSettings(NativeLibToken token, MeshComputeSettings settings);
